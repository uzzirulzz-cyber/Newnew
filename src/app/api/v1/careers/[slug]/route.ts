 ...
 *
 * Returns a single published job listing by slug. Hardcoded sample data —
 * swap for a real lookup once a JobListing model exists.
 */
export async function GET(
  ...
  const job = items.find((j) => j.slug === slug);
